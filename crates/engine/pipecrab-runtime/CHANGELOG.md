...
## [0.7.1](https://github.com/SheaHawkins/pipecrab/compare/pipecrab-runtime-v0.7.0...pipecrab-runtime-v0.7.1) - 2026-09-22

### Added

- run the VAD + STT pipeline in the browser ([#86](https://github.com/SheaHawkins/pipecrab/pull/86))
...
## [0.3.0](https://github.com/SheaHawkins/pipecrab/compare/pipecrab-runtime-v0.2.0...pipecrab-runtime-v0.3.0) - 2026-07-13

### Fixed

- *(pipeline)* erase stage Effects so stages are composable ([#40](https://github.com/SheaHawkins/pipecrab/pull/40))
